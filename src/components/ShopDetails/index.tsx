            ...
            <div className="lg:max-w-[570px] w-full">
              <div className="lg:min-h-[512px] rounded-lg shadow-1 bg-gray-2 p-4 sm:p-7.5 relative flex items-center justify-center">
                <div>
                  ...
                  {currentProduct.imgs ? (
                  <Image
                    src={currentProduct.imgs?.previews[previewImg] || "/placeholder.png"}
                    alt="product-details"
                    width={400}
                    height={400}
                  /> 
                ) : (
                  <div className="w-[400px] h-[400px] bg-gray-100 flex items-center justify-center text-sm text-gray-400">
                    No Image Available
                  </div>
                )}
                </div>
