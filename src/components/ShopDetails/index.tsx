        ...
        <>
              ...
              <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-17.5">
                ...
                <div className="max-w-[539px] w-full">
                  ...
                  <h3 className="font-medium text-custom-1 mb-4.5">
                    ...
                    Price: <Price price={product.discountedPrice || product.price} />
                  </span>
          ...
          <section className="overflow-hidden bg-gray-2 py-20">
            <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
              ...
              <div className="mt-8 space-y-6 bg-white p-6 rounded-xl shadow-sm">
              {/* Description */}
              {activeTab === "tab1" && (
                <div>
              ...
              {activeTab === "tab2" && (
                <div>
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                    {product.productAttrb?.productType && (
                      <li>
                        <strong>Type:</strong> {product.productAttrb.productType}
                      </li>
                    )}
                    {product.productAttrb?.isEcoFriendly && (
                      <li>
                        <strong>Eco-Friendly:</strong> Yes
                      </li>
                    )}
                    {product.productAttrb?.isOrganic && (
                      <li>
                    ...
                    {!product.productAttrb?.productType &&
                      !product.productAttrb?.isEcoFriendly &&
                      !product.productAttrb?.isOrganic && (
                        <li>No product attributes available.</li>
                      )}
                  </ul>
                </div>
              )}
              ...
              {activeTab === "tab3" && (
                <div>
                  ...
                  <p className="text-gray-700">
                    {product.reviews ? `${product.reviews} ⭐` : "No reviews yet."}
                  </p>
                </div>
              )}
            </div>
