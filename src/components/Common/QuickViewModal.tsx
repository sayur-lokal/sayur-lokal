                ...
                <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
                  <div>
                    <button
                      ...
                      className="gallery__Image w-10 h-10 rounded-[5px] bg-white shadow-1 flex items-center justify-center ease-out duration-200 text-dark hover:text-[#D75A4A] absolute top-4 lg:top-8 right-4 lg:right-8 z-50"
                    >
            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button
                  ...
                  className={`inline-flex font-medium text-white bg-green-dark py-3 px-7 rounded-md ease-out duration-200 hover:bg-[#1A693A]
                  `}
                >
                  Add to Cart
                </button>

                <button className={`inline-flex items-center gap-2 font-medium text-white bg-green-dark py-3 px-6 rounded-md ease-out duration-200 hover:bg-[#1A693A] `}>
