          ...
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
            ...
            <div className="mt-5.5">
              <form>
                ...
                {/* harusnya berupa button yg mengarahkan ke halaman beritkunya namun juga merekam data yg diinput */}
                <div className="w-full flex justify-center font-medium text-white bg-dark py-3 px-6 rounded-lg ease-out duration-200 hover:bg-blue mt-7.5">
                  <Link href="/signup/seller/shop">Next</Link>
                </div>
