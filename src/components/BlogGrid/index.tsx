          ...
          <div className="flex justify-center mt-15">
            <div className="bg-white shadow-1 rounded-md p-2">
              <ul className="flex items-center">
                ...
                <li>
                  <a href="#" className="flex py-1.5 px-3.5 duration-200 rounded-[3px] text-white hover:text-white hover:bg-[#1A693A] bg-green-dark">
                    1
                  </a>
                </li>

                <li>
                  <a href="#" className="flex py-1.5 px-3.5 duration-200 rounded-[3px] hover:text-white hover:bg-[#1A693A] bg-green-dark">
                    2
                  </a>
                </li>
