  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-10">
      ...
      <div className="min-w-[150px] flex justify-end">
        <button onClick={() => handleAddToCart()} className="inline-flex text-dark hover:text-white bg-gray-1 border border-gray-3 py-2.5 px-6 rounded-md ease-out duration-200 hover:bg-[#1A693A] hover:border-gray-3">
          Add to Cart
        </button>
      </div>
    </div>
