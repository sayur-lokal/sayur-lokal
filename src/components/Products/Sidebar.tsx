...
const Sidebar = ({ productSidebar, setProductSidebar, stickyMenu, disabled }: { productSidebar: boolean, setProductSidebar: Dispatch<SetStateAction<boolean>>; stickyMenu: boolean; disabled?: boolean }) => {
    return (
        <div
        ...
        >
            ...
            <form onSubmit={(e) => e.preventDefault()}>
                <div className="flex flex-col gap-6">
                    ...
                    <PriceDropdown disabled={!!disabled} />
                </div>
            </form>
        </div>
    );
