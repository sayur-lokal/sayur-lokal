        ...
        <div className="flex justify-center mt-15">
            <div className="bg-white shadow-1 rounded-md p-2">
                <ul className="flex items-center gap-2">
                    <li>
                        <button disabled={!pageConfig.canGoPrev} onClick={() => router.push(createHref(currentPage -1))} id="paginationLeft" aria-label="button for pagination left" type="button" className="flex items-center justify-center w-8 h-9 ease-out duration-200 rounded-[3px disabled:text-gray-4">
                    ...
                    {pageConfig.showLeftPad ? <PaginationPad /> : null}
                    ...
                    <li className="mx-1">
                        <button disabled={!pageConfig.canGoNext} onClick={() => router.push(createHref(currentPage + 1))} id="paginationLeft" aria-label="button for pagination left" type="button" className="flex items-center justify-center w-8 h-9 ease-out duration-200 rounded-[3px] hover:text-[#D75A4A] bg-white disabled:text-gray-4">
                            <svg className="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
