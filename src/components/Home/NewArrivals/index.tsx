      ...
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="mb-7 flex items-center justify-between">
          ...
          <Link
            ...
            className="inline-flex font-medium text-custom-sm py-2.5 px-7 rounded-md border-gray-3 border bg-gray-1 text-dark ease-out duration-200 hover:bg-green-dark hover:text-white hover:border-transparent"
          >
            View All
          </Link>
        </div>
